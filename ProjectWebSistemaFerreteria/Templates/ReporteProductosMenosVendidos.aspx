<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master" CodeBehind="ReporteProductosMenosVendidos.aspx.vb" Inherits="ProjectWebSistemaFerreteria.ReporteProductosMenosVendidos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link rel="stylesheet" href="../CSS/ReporteProductosMenosVendidos.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="contenedor p-0">
    <h1>Reporte de productos menos vendidos</h1>
    <section>
    ...
    <div class="contenedor-grafico">
        ...
        <div id="columnchart_values" style="width: min(100%,900px); height: max(100%,500px);"></div>
    </div>
</div>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<script src="../JS/ReporteProductosMenosVendidos.js"></script>
</asp:Content>
