<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master" CodeBehind="ReporteProductosMasVendidos.aspx.vb" Inherits="ProjectWebSistemaFerreteria.ReporteProductosMasVendidos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="../CSS/ReporteProductosMasVendidos.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="../JS/ReporteProductosMasVendidos.js"></script>
</asp:Content>
