...
function drawChart() {
    ...
    var data = google.visualization.arrayToDataTable([
        ...
        [dsql[0][0], dsql[0][1], "#370617"],
        [dsql[1][0], dsql[1][1], "#6a040f"],
        [dsql[2][0], dsql[2][1], "#9d0208"],
        [dsql[3][0], dsql[3][1], "#d00000"],
        [dsql[4][0], dsql[4][1], "#dc2f02"]
    ]);
    ...
    view.setColumns([0, 1,
        ...
        2]);
    var options = {
        title: "Los 5 productos menos vendidos " + tiempo_grafico.value,
        width: 900,
        height: 500,
        bar: { groupWidth: "92%" },
